...
#include </Programming/C++ yolo/C++ yolo/Shader.h>
#include <iostream>
...
int main()
{
    ...
    Shader ourShader("3.3.vshader.vs", "3.3.fshader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.use();
        //int fwip = glGetUniformLocation(shaderProgram, "flip");
        //glUniform1i(fwip, (int)flip);
